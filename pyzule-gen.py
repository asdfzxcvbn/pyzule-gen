...
if not any((args.f, args.u, args.w, args.m, args.d, args.n, args.v, args.b, args.s, args.e, args.r, args.k, args.x, args.l)):
...
with ZipFile(args.o, "w", ZIP_DEFLATED, compresslevel=4) as zf:
    with zf.open("config.json", "w") as f:
        f.write(orjson.dumps(used, option=orjson.OPT_INDENT_2))
